...
#model.save('/vol/bitbucket/zz6117/DNNreimplement/Model_trained/Model_saved_1.h5')
#new_model = tf.keras.models.load_model('/vol/bitbucket/zz6117/DNNreimplement/Model_trained/Model_saved_1.h5', custom_objects = {'rendering_loss' : rendering_loss},compile=False )
