...
opt = Adam(lr=0.00002)
new_model = tf.keras.models.load_model('E:\workspace_ms_zhiyuan\DNNreimplement\Model_trained\Model_saved_1', custom_objects = {'rendering_loss' : l1_loss},compile=False )
new_model.summary()
new_model.compile(optimizer = opt, loss = l1_loss, metrics = ['accuracy'])
