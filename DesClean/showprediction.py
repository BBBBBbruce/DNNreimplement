...
test_path =  'E:\workspace_ms_zhiyuan\Data_Deschaintre18\\trainBlended'
print('load_data')
...
new_model = tf.keras.models.load_model('E:\workspace_ms_zhiyuan\DNNreimplement\Model_trained\Model_trained\Model_saved_rl', custom_objects = {'rendering_loss' : rendering_loss},compile=False )
new_model.compile(optimizer = opt, loss = rendering_loss, metrics = ['mse'])
show_predictions(ds,new_model,5)
