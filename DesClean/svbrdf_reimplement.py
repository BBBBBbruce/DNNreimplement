...
def SVBRDF_moments(num_classes):
    inputs = keras.Input(shape=(256,256) + (3,))
...
def SVBRDF_reducemean(num_classes):
    inputs = keras.Input(shape=(256,256) + (3,))
