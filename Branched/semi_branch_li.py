...
def SVBRDF_semi_branched_li():
    print("SEMI BRANCHED_li")
...
#=========================
    ...
    s_outputs = layers.Conv2D(4, kernel_size = 1, activation="tanh", padding="same")(s_decoder1)
...
#================
    ...
    outputs = layers.Concatenate()([a_outputs,s_outputs,n_outputs])
    model = keras.Model(inputs, outputs)
    return model

#model = SVBRDF_semi_branched_li()
#model.summary()